...
import { FaqItem } from "../faqs-item/faqItem";
  ...
  return (
    <Flex gap={4} direction="column">
      ...
      <FaqItem
        ...
        answer={
          <>
            When you receive the hot potato NFT you can transfer it using our
            web app by connecting your wallet and following the prompts. If you
            run into any trouble at this stage please email:{" "}
            <Link href="mailto:samina@thirdweb.com">samina@thirdweb.com</Link>
          </>
        }
      />
      <FaqItem
